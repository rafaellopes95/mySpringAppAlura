...
<body>
	...
	<article id="livro-css-eficiente">
		...
		<section class="buy-options clearfix">
			<!-- Temos o atribudo action com o valor /carrinho/add. Este tipo de endereço, faz com que o contexto da aplicação seja perdido. 
			A tag c:url da JSTL cria URLs baseadas no contexto. Ela resolverá nosso problema. -->
			<form action='<c:url value="/carrinho/add"></c:url>' method="post" class="container">
